    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('In Process', 'In Process'), ('Complited on Stock', 'Complited on Stock'), ('Deliveried', 'Deliveried'), ('On the way', 'On the way')], max_length=100)),
                ('delivery_adress', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('delivery_notification_before', models.PositiveSmallIntegerField(choices=[(24, 24), (6, 6), (1, 1)], default=6)),
